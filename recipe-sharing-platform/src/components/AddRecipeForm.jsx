...
const validationSchema = Yup.object({
    ...
    instructions:Yup.string().required('At minimum the food should contain 2 instructions')
})
            ...
            >
                {()=>(
                    <Form className="flex flex-col">
                        ...
                        <Field type="text" placeholder="Instructions" name="instructions" className="border-2 border-gray-400 rounded-lg pl-3 pt-3 m-4 pb-24 w-72 shadow-2xl" required/> 
